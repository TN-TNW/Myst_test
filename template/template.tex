...
\usepackage{framed} \usepackage{hyperref}
\usepackage{amssymb}
...
\newcounter{assignment}[chapter]
\renewcommand{\theassignment}{\thechapter.\arabic{assignment}}

\newenvironment{assignment}[1][]{
  \refstepcounter{assignment}
  \begin{framed}
  \textbf{Opdracht~\theassignment} \ifx\\#1\\\else~--~#1\fi
  \par
}{
  \end{framed}
}
